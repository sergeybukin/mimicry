const calcUTCI = function (temp, Tmrt, ws, RH, clo) {
...
const calcReflect = (rgb, percentage) => {
  const values = rgb
...
//set -
const tshirt = calcReflect("rgb(255,227,95)", 0.4);
const jeans = calcReflect("rgb(172,255,128)", 0.4);
const cap = calcReflect("rgb(255,255,255)", 0.06);
console.log(tshirt + jeans + cap);
